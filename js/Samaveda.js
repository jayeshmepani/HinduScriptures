document.addEventListener("DOMContentLoaded", function () {
  const url = '/DharmicData/Veda/Samaved/SamaVeda_Kauthuma.pdf';
    ...
    pdfDoc.getPage(num).then(page => {
      ...
      page.getOperatorList()
        ...
        .then(function (svg) {
          ...
          svg.querySelectorAll('g[transform="matrix(5.65688 5.65688 -5.65688 5.65688 -1701.414 2079.814)"]').forEach(function (element) {
            element.remove();
          });
